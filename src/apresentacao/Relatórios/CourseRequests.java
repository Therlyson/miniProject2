...
public class CourseRequests extends JFrame{
    String nomeCurso;
    Department department;
    public CourseRequests(Department department, String nomeCurso){
        ...
        JLabel name = new JLabel("Todas as solicitações do curso de "+ nomeCurso);
    ...
    private void exibirInformacoes(){
        ArrayList<Request> cursos = department.pesquisaPorCurso(nomeCurso);
