...
public class RegisterFixed extends JFrame{
    Department department;
    JTextField fieldTipo, fieldCapacidade, fieldNome, fieldLocalizacao;
    JTextField fieldHorario, fieldAno, fieldSemestre, fieldCurso, fieldVagas, fieldData, fieldDisciplina;
    public RegisterFixed(Department department, String nome) {
        ...
        disciplina.setBounds(590,400,500,50);
        disciplina.setFont(new Font("Arial", Font.ITALIC, 17));
        add(disciplina);
        fieldDisciplina = new JTextField();
        fieldDisciplina.setBounds(680,406,300,30);
        fieldDisciplina.setFont(new Font("Arial", Font.ITALIC, 17));
        fieldDisciplina.setSelectionColor(Color.black);
        add(fieldDisciplina);
    ...
    private void btnSalvarActionPerformed(ActionEvent actionEvent){
        ...
        String disciplina = fieldDisciplina.getText();
        ...
        && !disciplina.isEmpty()){
            try{
                ...
                Request fixedRequest = new FixedRequest(ano1, semestre, curso, vagas1, h, espacoFisico, data, disciplina);
